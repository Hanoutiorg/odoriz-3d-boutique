...
const DEFAULT_PRODUCTS = [
  { id: 1, name: "Bleu de Chanel", brand: "Chanel", category: "Pour Homme", price: 410.00, stock: 50, imageUrl: "/images/bleu-de-chanel.png", model3DUrl: null, description: "Une ode à la liberté masculine dans un aromatique-boisé au sillage captivant.", olfactoryNotes: { top: "Agrumes, Vétiver", middle: "Pamplemousse, Cèdre", base: "Encens, Gingembre" }, rating: 4.8, isNewProduct: false, isBestSeller: true },
  { id: 2, name: "J'adore", brand: "Dior", category: "Pour Femme", price: 460.00, stock: 30, imageUrl: "/images/jadore.png", model3DUrl: null, description: "J'adore est le grand floral féminin de Dior.", olfactoryNotes: { top: "Ylang-Ylang", middle: "Rose Damascena", base: "Jasmin Sambac" }, rating: 4.9, isNewProduct: false, isBestSeller: true },
  { id: 3, name: "Baccarat Rouge 540", brand: "Maison Francis Kurkdjian", category: "Niche", price: 740.00, stock: 15, imageUrl: "/images/baccarat-rouge.png", model3DUrl: null, description: "Une signature olfactive graphique et condensée à l'extrême.", olfactoryNotes: { top: "Jasmin, Safran", middle: "Ambre gris", base: "Bois de cèdre" }, rating: 5.0, isNewProduct: true, isBestSeller: false },
  { id: 4, name: "Aventus", brand: "Creed", category: "Pour Homme", price: 1050.00, stock: 20, imageUrl: "/images/aventus.png", model3DUrl: null, description: "Aventus célèbre la force, la puissance et le succès.", olfactoryNotes: { top: "Ananas, Cassis", middle: "Rose, Bouleau", base: "Chêne, Ambre gris" }, rating: 4.7, isNewProduct: true, isBestSeller: false }
];
...
let orders = [
  { id: "ORD001", userId: 2, date: "2024-05-15T10:00:00Z", status: "Livrée", total: 460.00, items: [{ productId: 2, quantity: 1, price: 460.00, productName: "J'adore" }], shippingAddress: { fullName: "Walid Ben Ahmed (Maison)", address: "15 Rue de la Liberté", city: "Tunis", postalCode: "1001", gouvernorat: "Tunis", country: "Tunisie" } }
];

const discounts = [
  { id: 1, code: "BIENVENUE10", type: "percentage", value: 10, isActive: true, description: "10% de réduction pour les nouveaux clients" },
  { id: 2, code: "AID50", type: "fixed", value: 50, isActive: true, description: "50 TND de réduction pour l'Aïd" }
];

const adminStats = {
  totalRevenue: 12450.00, totalOrders: 156, newCustomers: 23, totalProducts: products.length,
  salesData: [
    { date: "2024-05-01", sales: 850 }, { date: "2024-05-02", sales: 1200 }, { date: "2024-05-03", sales: 950 },
    { date: "2024-05-04", sales: 1400 }, { date: "2024-05-05", sales: 1100 }, { date: "2024-05-06", sales: 1600 },
