...
const ProductDetail = () => {
  ...
  // Images du produit (simulation avec plusieurs vues)
  const productImages = [
    product.imageUrl,
    product.imageUrl, // Pour l'exemple, on répète la même image
    product.imageUrl,
  ];
        ...
        >
          <Tabs defaultValue="description" className="w-full">
            <TabsList className="grid w-full grid-cols-3">
              ...
              <TabsTrigger value="notes">Notes Olfactives</TabsTrigger>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="space-y-6">
                    <div>
                      <h4 className="font-semibold text-accent mb-2">Notes de Tête</h4>
                      <p className="text-muted-foreground">{product.olfactoryNotes.top}</p>
                    </div>
                    <Separator />
                    <div>
                      <h4 className="font-semibold text-accent mb-2">Notes de Cœur</h4>
                      <p className="text-muted-foreground">{product.olfactoryNotes.middle}</p>
                    </div>
                    <Separator />
                    <div>
                      <h4 className="font-semibold text-accent mb-2">Notes de Fond</h4>
                      <p className="text-muted-foreground">{product.olfactoryNotes.base}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
